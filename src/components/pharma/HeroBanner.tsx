...
import { FaIndustry, FaInfoCircle } from "react-icons/fa";
...
export default function HeroBanner() {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-black">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 items-center">
              <Tooltip content="Request a tailored quote for your line">
              ...
              <Tooltip content="See our factory capabilities">
                <Button
                  variant="outline"
            ...
            {/* Small accordion for quick specs */}
          ...
          {/* Right: 3D factory card (tilt + hover) */}
          <motion.div
            ref={containerRef}
          ...
          >
            ...
            >
              {/* "3D" image - prefers a PNG with transparent bg */}
      ...
      {/* Decorative scroll hint (bottom center) */}
      <motion.div
